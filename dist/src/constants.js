...
var querybuilder_1 = require("@neode/querybuilder");
var areaBump_1 = __importDefault(require("./components/reports/areaBump"));
var bar_1 = __importDefault(require("./components/reports/bar"));
var bump_1 = __importDefault(require("./components/reports/bump"));
var chord_1 = __importDefault(require("./components/reports/chord"));
var funnel_1 = __importDefault(require("./components/reports/funnel"));
var line_1 = __importDefault(require("./components/reports/line"));
var metric_1 = __importDefault(require("./components/reports/metric"));
var radar_1 = __importDefault(require("./components/reports/radar"));
var bubble_1 = __importDefault(require("./components/reports/bubble"));
var table_1 = __importDefault(require("./components/reports/table"));
var calendar_1 = __importDefault(require("./components/reports/calendar"));
var heatMap_1 = __importDefault(require("./components/reports/heatMap"));
var network_1 = __importDefault(require("./components/reports/network"));
var sankey_1 = __importDefault(require("./components/reports/sankey"));
var scatterplot_1 = __importDefault(require("./components/reports/scatterplot"));
var stream_1 = __importDefault(require("./components/reports/stream"));
exports.operators = {
    'equals': querybuilder_1.Operator.EQUALS,
    'contains': querybuilder_1.Operator.CONTAINS,
    'starts with': querybuilder_1.Operator.STARTS_WITH,
    'ends with': querybuilder_1.Operator.ENDS_WITH,
    'greater than': querybuilder_1.Operator.GREATER_THAN,
    'greater than or equal': querybuilder_1.Operator.GREATER_THAN_OR_EQUAL,
    'less than': querybuilder_1.Operator.LESS_THAN,
    'less than or equal': querybuilder_1.Operator.LESS_THAN_OR_EQUAL,
};
exports.conditions = Object.keys(exports.operators);
exports.directions = {
    in: querybuilder_1.Direction.INCOMING,
    out: querybuilder_1.Direction.OUTGOING,
    both: querybuilder_1.Direction.BOTH,
};
exports.reportSources = [
    { key: 'cypher', value: 'cypher', text: 'Raw Cypher Query', },
    { key: 'query', value: 'query', text: 'Query from Query Builder', },
];
exports.TYPE_METRIC = 'metric';
exports.TYPE_TABLE = 'table';
exports.TYPE_BAR = 'bar';
exports.TYPE_STACKED_BAR = 'stackedbar';
exports.TYPE_HORIZONTAL_BAR = 'horizontalbar';
exports.TYPE_HORIZONTAL_STACKED_BAR = 'horizontalstackedbar';
exports.TYPE_LINE = 'line';
exports.TYPE_RADAR = 'radar';
exports.TYPE_FUNNEL = 'funnel';
exports.TYPE_HORIZONTAL_FUNNEL = 'horizontalfunnel';
exports.TYPE_BUMP = 'bump';
exports.TYPE_AREA_BUMP = 'areabump';
exports.TYPE_CHORD = 'chord';
exports.TYPE_BUBBLE = 'bubble';
exports.TYPE_CALENDAR = 'calendar';
exports.TYPE_HEAT_MAP = 'heatmap';
exports.TYPE_NETWORK = 'network';
exports.TYPE_SANKEY = 'sankey';
exports.TYPE_VERTICAL_SANKEY = 'verticalsankey';
exports.TYPE_SCATTER_PLOT = 'scatterplot';
exports.TYPE_STREAM = 'stream';
var barExampleQuery = "MATCH (m:Movie)-[:IN_GENRE]->(g)\nWHERE\n    m.release_date.year > 2010\nRETURN m.release_date.year AS index,\n    g.name AS key,\n    count(*) AS value\nORDER BY index DESC LIMIT 20";
var barPreviewQuery = "UNWIND [[2012, \"(no genres listed)\", 1], [2012, \"Action\", 51], [2012, \"Adventure\", 24], [2012, \"Animation\", 20], [2012, \"Children\", 7], [2012, \"Comedy\", 77], [2012, \"Crime\", 27], [2012, \"Documentary\", 27], [2012, \"Drama\", 86], [2012, \"Fantasy\", 17], [2012, \"Film-Noir\", 1], [2012, \"Horror\", 21], [2012, \"IMAX\", 22], [2012, \"Musical\", 10], [2012, \"Mystery\", 5], [2012, \"Romance\", 25], [2012, \"Sci-Fi\", 25], [2012, \"Thriller\", 48], [2012, \"War\", 2], [2012, \"Western\", 1], [2013, \"(no genres listed)\", 1], [2013, \"Action\", 49], [2013, \"Adventure\", 32], [2013, \"Animation\", 13], [2013, \"Children\", 7], [2013, \"Comedy\", 70], [2013, \"Crime\", 30], [2013, \"Documentary\", 21], [2013, \"Drama\", 99], [2013, \"Fantasy\", 22], [2013, \"Film-Noir\", 1], [2013, \"Horror\", 12], [2013, \"IMAX\", 26], [2013, \"Musical\", 2], [2013, \"Mystery\", 10], [2013, \"Romance\", 23], [2013, \"Sci-Fi\", 18], [2013, \"Thriller\", 37], [2013, \"War\", 2], [2013, \"Western\", 1], [2014, \"Action\", 52], [2014, \"Adventure\", 27], [2014, \"Animation\", 14], [2014, \"Children\", 10], [2014, \"Comedy\", 89], [2014, \"Crime\", 28], [2014, \"Documentary\", 18], [2014, \"Drama\", 109], [2014, \"Fantasy\", 14], [2014, \"Horror\", 18], [2014, \"IMAX\", 15], [2014, \"Musical\", 2], [2014, \"Mystery\", 11], [2014, \"Romance\", 33], [2014, \"Sci-Fi\", 25], [2014, \"Thriller\", 42], [2014, \"War\", 8], [2014, \"Western\", 1], [2015, \"(no genres listed)\", 6], [2015, \"Action\", 45], [2015, \"Adventure\", 31], [2015, \"Animation\", 7], [2015, \"Children\", 11], [2015, \"Comedy\", 71], [2015, \"Crime\", 23], [2015, \"Documentary\", 17], [2015, \"Drama\", 83], [2015, \"Fantasy\", 12], [2015, \"Horror\", 22], [2015, \"IMAX\", 1], [2015, \"Mystery\", 11], [2015, \"Romance\", 15], [2015, \"Sci-Fi\", 25], [2015, \"Thriller\", 51], [2015, \"War\", 3], [2015, \"Western\", 3], [2016, \"(no genres listed)\", 3], [2016, \"Action\", 22], [2016, \"Adventure\", 18], [2016, \"Animation\", 7], [2016, \"Children\", 2], [2016, \"Comedy\", 20], [2016, \"Crime\", 3], [2016, \"Documentary\", 5], [2016, \"Drama\", 17], [2016, \"Fantasy\", 8], [2016, \"Horror\", 10], [2016, \"Musical\", 1], [2016, \"Mystery\", 3], [2016, \"Romance\", 7], [2016, \"Sci-Fi\", 13], [2016, \"Thriller\", 14], [2016, \"Western\", 1]] AS row RETURN row[0] as index, row[1] as key, row[2] as value";
exports.reportTypes = [
    {
        key: exports.TYPE_METRIC,
        value: exports.TYPE_METRIC, text: 'Metric',
        ...
        component: metric_1.default,
    },
    {
        key: exports.TYPE_TABLE,
        value: exports.TYPE_TABLE,
        text: 'Table',
    ...
    {
        key: exports.TYPE_BAR,
        value: exports.TYPE_BAR,
        text: 'Bar Chart',
    ...
    {
        key: exports.TYPE_STACKED_BAR,
        value: exports.TYPE_STACKED_BAR,
    ...
    {
        key: exports.TYPE_HORIZONTAL_BAR,
        value: exports.TYPE_HORIZONTAL_BAR,
    ...
    {
        key: exports.TYPE_HORIZONTAL_STACKED_BAR,
        value: exports.TYPE_HORIZONTAL_STACKED_BAR,
    ...
    {
        key: exports.TYPE_LINE,
        value: exports.TYPE_LINE,
        text: 'Line Chart',
    ...
    {
        key: exports.TYPE_FUNNEL,
        value: exports.TYPE_FUNNEL,
        text: 'Funnel Chart',
        hint: 'A Funnel chart expects rows with three keys: `id`, `value` and `label`',
        component: funnel_1.default,
    ...
    {
        key: exports.TYPE_HORIZONTAL_FUNNEL,
        value: exports.TYPE_HORIZONTAL_FUNNEL,
    ...
    {
        key: exports.TYPE_BUMP,
        value: exports.TYPE_BUMP,
        text: 'Bump Chart',
        hint: 'A Bump chart expects rows with three keys: `id`, `x` and `y`',
        component: bump_1.default,
    ...
    {
        key: exports.TYPE_AREA_BUMP,
        value: exports.TYPE_AREA_BUMP,
        text: 'Area Bump Chart',
        hint: 'An Area Bump chart expects rows with three keys: `id`, `x` and `y`',
        component: areaBump_1.default,
        previewQuery: 'UNWIND[{id:"Serie1",data:[{x:2000,y:12},{x:2001,y:3},{x:2002,y:1},{x:2003,y:12},{x:2004,y:12}]},{id:"Serie2",data:[{x:2000,y:8},{x:2001,y:9},{x:2002,y:8},{x:2003,y:5},{x:2004,y:1}]},{id:"Serie3",data:[{x:2000,y:9},{x:2001,y:10},{x:2002,y:9},{x:2003,y:8},{x:2004,y:7}]},{id:"Serie4",data:[{x:2000,y:5},{x:2001,y:12},{x:2002,y:11},{x:2003,y:11},{x:2004,y:3}]},{id:"Serie5",data:[{x:2000,y:11},{x:2001,y:8},{x:2002,y:3},{x:2003,y:4},{x:2004,y:11}]},{id:"Serie6",data:[{x:2000,y:2},{x:2001,y:11},{x:2002,y:12},{x:2003,y:6},{x:2004,y:4}]},{id:"Serie7",data:[{x:2000,y:10},{x:2001,y:7},{x:2002,y:7},{x:2003,y:10},{x:2004,y:8}]},{id:"Serie8",data:[{x:2000,y:7},{x:2001,y:5},{x:2002,y:2},{x:2003,y:7},{x:2004,y:6}]},{id:"Serie9",data:[{x:2000,y:1},{x:2001,y:1},{x:2002,y:4},{x:2003,y:9},{x:2004,y:5}]},{id:"Serie10",data:[{x:2000,y:3},{x:2001,y:4},{x:2002,y:5},{x:2003,y:1},{x:2004,y:9}]},{id:"Serie11",data:[{x:2000,y:6},{x:2001,y:6},{x:2002,y:10},{x:2003,y:2},{x:2004,y:10}]},{id:"Serie12",data:[{x:2000,y:4},{x:2001,y:2},{x:2002,y:6},{x:2003,y:3},{x:2004,y:2}]}] AS row UNWIND row.data as d RETURN row.id AS id,d.x AS x,d.y AS y'
    },
    {
        key: exports.TYPE_CHORD,
        value: exports.TYPE_CHORD,
        text: 'Chord Chart',
        hint: 'A Chord chart expects rows with three keys: `from`, `to` and `value`',
        component: chord_1.default,
    ...
    {
        key: exports.TYPE_BUBBLE,
        value: exports.TYPE_BUBBLE,
        text: 'Bubble Chart',
        hint: 'A Bubble chart expects rows with three keys: `from`, `to` and `value`',
        component: bubble_1.default,
    ...
    {
        key: exports.TYPE_CALENDAR,
        value: exports.TYPE_CALENDAR,
        text: 'Calendar Chart',
    ...
    {
        key: exports.TYPE_HEAT_MAP,
        value: exports.TYPE_HEAT_MAP,
        text: 'Heat Map',
    ...
    {
        key: exports.TYPE_NETWORK,
        value: exports.TYPE_NETWORK,
        text: 'Network',
        hint: 'A Network expects rows with two keys: `from` and `to`.  Optionally you can supply a `color` and `radius`',
        component: network_1.default,
        previewQuery: "\n            UNWIND [\n            { from: 'Adam', to: 'Kane', value: 1 },\n            { from: 'Adam', to: 'Abel' },\n            { from: 'Kane', to: 'Enoch' },\n            { from: 'Enoch', to: 'Lemech' },\n            { from: 'Enoch', to: 'Ada' },\n            { from: 'Enoch', to: 'Tzila' },\n            { from: 'Adam', to: 'Seth' },\n            { from: 'Seth', to: 'Enosh' },\n            { from: 'Enoch', to: 'All Humanity' }\n           ] AS row\n           RETURN row.from AS from, row.to AS to, row.value AS value",
    },
    {
        key: exports.TYPE_SANKEY,
        value: exports.TYPE_SANKEY,
        text: 'Sankey',
    ...
    {
        key: exports.TYPE_VERTICAL_SANKEY,
        value: exports.TYPE_VERTICAL_SANKEY,
    ...
    {
        key: exports.TYPE_SCATTER_PLOT,
        value: exports.TYPE_SCATTER_PLOT,
        ...
        component: scatterplot_1.default,
        // exampleQuery: barExampleQuery,
    ...
    {
        key: exports.TYPE_STREAM,
        value: exports.TYPE_STREAM,
        text: 'Stream Chart',
...
function getHint(type) {
    return exports.reportTypes.find(function (row) { return row.value === type; }).hint;
}
exports.getHint = getHint;
exports.aggregateFunctions = [
