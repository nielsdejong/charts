...
function AreaBumpReport(props) {
    ...
    return (react_1.default.createElement("div", { className: "h-full w-full overflow-hidden" },
        react_1.default.createElement(bump_1.ResponsiveAreaBump, { data: data, margin: { top: 32, right: 100, bottom: 32, left: 24 } })));
}
exports.default = AreaBumpReport;
